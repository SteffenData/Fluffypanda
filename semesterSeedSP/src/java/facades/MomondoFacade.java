...
//            em.persist(reservation);
    ...
    public List<Reservation> getReservationByUsername(String username)
    {
        ...
        {
            User u = em.find(User.class, username);
            TypedQuery<Reservation> resQuery = em.createQuery("SELECT r From Reservation r WHERE r.user =:u", Reservation.class);
            resQuery.setParameter("u", u);
            reservationList = resQuery.getResultList();
        } finally
        {
            em.close();
        }
